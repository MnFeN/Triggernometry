...
namespace Triggernometry.Forms
{
    public partial class GameConfigForm : Form
    {
        ...
        public GameConfigForm(ConfigInfo info)
        {
            ...
            Info = info;
            // load config
            Config = RealPlugin.plug.cfg.PersistentVariables.Dict.TryGetValue(Info.ConfigName, out var cfg) 
        ...
        {
            preset = RealPlugin.plug.cfg.PersistentVariables.Dict.TryGetValue($"{Info.ConfigName}{index}", out var currentPreset)
        ...
        public void SaveToConfig()
        {
            ...
            RealPlugin.plug.cfg.PersistentVariables.Dict[Info.ConfigName] = Config;
            RealPlugin.plug.InvokeNamedCallback("command", "/e <se.10>");
            RealPlugin.plug.InvokeNamedCallback("command", $"/{Config.GetValue("cnlPrivate")} 已保存配置。");
            this.Close();
        }
        ...
        public void SaveToPreset(int presetIdx, string presetName)
        {
            ...
            RealPlugin.plug.cfg.PersistentVariables.Dict[$"{Info.ConfigName}{presetIdx}"] = preset;
        }
