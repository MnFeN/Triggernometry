...
namespace Triggernometry.Core.Actions
{
    ...
    internal class ActionKeypress : ActionBase
    {
        ...
        /// </summary>
        [Action(ordernum: 2, specialtype: ActionAttribute.SpecialTypeEnum.KeypressRecorder)]
        ...
        /// </summary>
        [Action(ordernum: 3, specialtype: ActionAttribute.SpecialTypeEnum.KeypressRecorder)]
        ...
        /// </summary>
        [Action(ordernum: 5, typehint: typeof(int))]
