    ...
    public partial class UserInterface : UserControl
    {
        ...
        internal void btnEdit_Click(object sender, EventArgs e)
        {
            if (treeView1.SelectedNode.Tag is Trigger t)
            {
                ...
                using (Forms.TriggerForm tf = new Forms.TriggerForm(t, treeView1, imageList1, readOnly, readMe))
                {
                    ...
                    if (tf.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        if (t.EditAutofire == true)
                        {
                            if (t.EditAutofireAllowCondition)
                                ForceFireTrigger(t, ActionOld.TriggerForceTypeEnum.SkipExceptConditions);
                            else
        ...
        internal void ImportResultsFromForm(Forms.ImportForm imf)
        {
            ...
            foreach (Trigger nt in newTrigs)
            {
                foreach (Core.ActionOld a in nt.Actions)
                {
        ...
        internal TriggernometryExport ExportSelection()
        {
            ...
            exp.PluginVersion = RealPlugin.Instance.cfg.PluginVersion;
            if (treeView1.SelectedNode.Tag is Trigger t)
            {
        ...
        internal void clearActionQueueToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            plug.UnfilteredAddToLog(DebugLevelEnum.Info, I18n.Translate(
                "internal/Core.Action/trigcancelall",
        ...
        internal void RecolorStartingFromNode(TreeNode tn, bool pstate, bool refreshActives)
        {
            object o = tn.Tag;
        ...
        private void deactivateAllAurasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            a._AuraOp = Core.ActionOld.AuraOpEnum.DeactivateAllAura;
            a._TextAuraOp = Core.ActionOld.AuraOpEnum.DeactivateAllAura;
            plug.ImageAuraManagement(Context.Unbound, a);
            plug.TextAuraManagement(Context.Unbound, a);
        }
        ...
        internal void ForceUpdateRepository(TreeNode tnupdate)
        {
            if (tnupdate == null)
            {
                return;
        ...
        private void ForceFireTrigger(Trigger t, Core.ActionOld.TriggerForceTypeEnum force)
        {
            ...
            else
            {
                ...
                force = Core.ActionOld.TriggerForceTypeEnum.SkipActive | Core.ActionOld.TriggerForceTypeEnum.SkipRefire | Core.ActionOld.TriggerForceTypeEnum.SkipParent;
                ...
                switch (t.Source)
                {
                    ...
                    case Trigger.TriggerSourceEnum.None:
                        force |= Core.ActionOld.TriggerForceTypeEnum.SkipRegexp;
                        source = LogEvent.SourceEnum.Log;
                        break;
                }
                foreach (string line in lines)
