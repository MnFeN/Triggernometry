    ...
    public partial class ConfigurationForm2 : MemoryForm<ConfigurationForm2>
    {
        ...
        internal void SettingsFromConfiguration(Configuration cfg)
        {
            ...
            if (cfg.UiFontName == null || cfg.UiFontName == "")
            {
                ...
                fic.Effect = TextAuraEffectEnum.None;
            }
            else
            {
        ...
        {
            IEnumerable<Configuration.APIUsage> apis = cfg.GetAPIUsages() ?? plug.GetDefaultAPIUsages();
        ...
        {
            using (TriggerForm tf = new TriggerForm(template, plug.ui.treeView1, plug.ui.imageList1))
            {
                Trigger.TriggerSourceEnum oldSource = template.Source;
